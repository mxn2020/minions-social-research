...
/**
 * @minions-social-research/cli — CLI for Minions Social-research
 *
...
import { customTypes } from '@minions-social-research/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Social-research'));
        console.log(chalk.dim('Trend sources, competitor snapshots, hashtag sets, and audience notes'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-social-research/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-social-research/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-social-research')}`);
